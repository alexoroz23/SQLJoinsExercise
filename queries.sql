...
SELECT first_name, last_name, COUNT(owner_id) FROM owners JOIN vehicles ON owners.id = vehicles.owner_id GROUP BY (owners.first_name, owners.last_name) ORDER BY owners.first_name;
